        ...
        <div class="row">
            <div class="col-md-12">
                <div class="call-to-wrap">
                    <h1 class="text--white">Cek juga Toko kami di Tokopedia.com!</h1>
                    <h4 class="text--white">Nantikan Project - Project kami diwebsite Maupun di Tokopedia.</h4>
                    <a href="#" style="background-color:#42b549;" class="btn btn--lg btn--round btn--white callto-action-btn"><b class="text-white"> Tokopedia</b> </a>
                </div>
            </div>
        </div>
    </div>
