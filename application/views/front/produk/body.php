                ...
                <div class="item-preview">
                    <div class="item__preview-slider">
                        <div class="prev-slide">
                            <?php
							if(empty($produk->foto)) {echo "<img src='".base_url()."assets/images/no_image_thumb.png' width='100%' height='400'>";}
							else{
							echo "
                    ...
                    <div class="tab tab2">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane product-tab fade show active" id="product-details">
                                <h2><b><?php echo $produk->judul_produk ?> </b></h2>
                                <p><?php echo $produk->deskripsi ?>
                                </p>

                                <div class="item_social_share" style="margin-bottom: 0px; padding-bottom: 0px;">
                    ...
                    <div class="author-card sidebar-card ">
                        ...
                        <div class="author-infos">
                            ...
                            <div class="author-btn">
                                <a href="<?php echo base_url('profil')?>" class="btn btn--sm btn--round">Lihat
                                    Profil</a>
                        ...
                        <div class="product product--card">
                            ...
                            <div class="product__thumbnail">
                                ...
                                <div class="prod_btn">
                                    ...
                                    <a href="<?php echo ("$lainnya->demo") ?>" target="_blank"
                            ...
                            <div class="product-desc">
                                <a href="<?php echo base_url('auth/login')  ?>" class="product_title">
                                    <h4 class="text-center"><?php echo character_limiter($lainnya->judul_produk,'50') ?>
                                    </h4>
                                </a>
                                <article class="text-center"><?php echo character_limiter($lainnya->deskripsi,'100') ?>
                                </article>
